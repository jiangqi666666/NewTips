package com.jiangqi.newtips.log;
...
public class MyConsumer {
	private static final String ZOOKEEPER = "192.168.3.101:2181,192.168.3.102:2181,192.168.3.103:2181";
    ...
    public static void main(String[] args) {
        ...
        ConsumerConnector consumerConnector = Consumer.createJavaConsumerConnector(consumerConfig);  // Consumer.createJavaConsumerConnector(consumerConfig);
